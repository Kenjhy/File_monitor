...
class FileMonitor:
    def __init__(self, output_file="en_file_monitor_amaris_test_cloudformation.txt", min_update_interval=2):
        """
...
files_to_monitor = [
    r"C:\Proyectos_software\Personal\compani_test\amaris-proyecto-fondos\cloudformation\backend-build-fixed.ps1",
    r"C:\Proyectos_software\Personal\compani_test\amaris-proyecto-fondos\cloudformation\backend-build.ps1",
    r"C:\Proyectos_software\Personal\compani_test\amaris-proyecto-fondos\cloudformation\deploy.ps1",
    r"C:\Proyectos_software\Personal\compani_test\amaris-proyecto-fondos\cloudformation\cleanup-bucket.ps1",
    r"C:\Proyectos_software\Personal\compani_test\amaris-proyecto-fondos\cloudformation\frontend-build.ps1",
    # r"C:\Proyectos_software\Personal\compani_test\amaris-proyecto-fondos\cloudformation\get-mfa-credentials.ps1",
    r"C:\Proyectos_software\Personal\compani_test\amaris-proyecto-fondos\cloudformation\template.yaml",
