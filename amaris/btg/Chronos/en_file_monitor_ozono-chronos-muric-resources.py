...
class FileMonitor:
    def __init__(self, output_file="en_file_monitor_ozono-chronos-muric-resources.txt", min_update_interval=2):
        """
...
files_to_monitor = [
    r"C:\Proyectos_software\Work\btg\Serverless\CHRONOS\ozono-chronos-muric-resources\serverless-files\general\custom.yml",
    r"C:\Proyectos_software\Work\btg\Serverless\CHRONOS\ozono-chronos-muric-resources\serverless-files\general\tags.yml",
    r"C:\Proyectos_software\Work\btg\Serverless\CHRONOS\ozono-chronos-muric-resources\serverless-files\resources\buckets\muricReportBucket.yml",
    r"C:\Proyectos_software\Work\btg\Serverless\CHRONOS\ozono-chronos-muric-resources\serverless-files\resources\conditions\conditions.yml",
    r"C:\Proyectos_software\Work\btg\Serverless\CHRONOS\ozono-chronos-muric-resources\serverless-files\resources\secrets\apisDLHCredentials.yml",
    r"C:\Proyectos_software\Work\btg\Serverless\CHRONOS\ozono-chronos-muric-resources\serverless-files\resources\secrets\apiUnityCredentials.yml",
    r"C:\Proyectos_software\Work\btg\Serverless\CHRONOS\ozono-chronos-muric-resources\serverless-files\resources\secrets\dbOzonoCredentials.yml",
    r"C:\Proyectos_software\Work\btg\Serverless\CHRONOS\ozono-chronos-muric-resources\.env",
    r"C:\Proyectos_software\Work\btg\Serverless\CHRONOS\ozono-chronos-muric-resources\azure-pipelines.yml",
    r"C:\Proyectos_software\Work\btg\Serverless\CHRONOS\ozono-chronos-muric-resources\serverless.yml"
]
