...
class FileMonitor:
    def __init__(self, output_file="en_file_monitor_amaris_test_backend_unit.txt", min_update_interval=2):
        """
...
files_to_monitor = [
    r"C:\Proyectos_software\Personal\compani_test\amaris-proyecto-fondos\backend\test\test_cliente_api.py",
    r"C:\Proyectos_software\Personal\compani_test\amaris-proyecto-fondos\backend\test\test_cliente_service.py",
    r"C:\Proyectos_software\Personal\compani_test\amaris-proyecto-fondos\backend\test\test_fondo_service.py",
    r"C:\Proyectos_software\Personal\compani_test\amaris-proyecto-fondos\backend\test\test_fondos_api.py",
    r"C:\Proyectos_software\Personal\compani_test\amaris-proyecto-fondos\backend\test\test_notificacion_service.py",
    r"C:\Proyectos_software\Personal\compani_test\amaris-proyecto-fondos\backend\test\test_transaccion_service.py",
    r"C:\Proyectos_software\Personal\compani_test\amaris-proyecto-fondos\backend\test\test_transacciones_api.py",
